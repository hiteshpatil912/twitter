      ...
      <div class="lg:w-full relative">
        ...
        >
          ...
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight">Hitesh Patil</p>
            <p class="text-sm leading-tight">@Soft.Developer</p>
          </div>
        ...
        >
          ...
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold">Hitesh Patil</p>
              <p class="text-sm text-dark ml-2">@Soft.Developer</p>
...
export default {
  ...
  data() {
    return {
      ...
      friends: [
        { src: "elon.jpg", name: "Hitesh A Patil", handle: "@teslaBoy" },
        { src: "monk.jpg", name: "Aabid shaha", handle: "@detective:)" },
        { src: "kevin.jpg", name: "Mahesh Deshmukh", handle: "@miniRock" },
        { src: "profile.png", name: "Diksha Sangare", handle: "@miniRock" },
      ],
      following: [
        {
          src: "elon.jpg",
        ...
        },
        {
          ...
          handle: "@teslagirl",
          time: "1.4 hr",
          tweet: "Build a twitter clone using vue.js and tailwind css!",
          comments: "100,500",
          retweets: "1,000,032",
          like: "8,000,103",
        },
